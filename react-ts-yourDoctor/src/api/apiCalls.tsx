...
export const bookAmbulance = async (dataToSend) => {
    ...
    .post(`${baseURL}/booking/ambulance`, dataToSend);
    return ret.data;
}

export const bookCheckup = async (dataToSend) => {
    const ret = await axios
        .post(`${baseURL}/booking/checkup`, dataToSend)
    return ret.data;
}

export const bookDoctor = async (dataToSend) => {
    const ret = await axios
        .post(`${baseURL}/booking/appointment`, dataToSend)
    return ret.data;
}

export const getTimeline = async (doctorID) => {
    const ret = await axios
        .get(`${baseURL}/doctor/timeline/${doctorID}`);
...
export const getComments_Chatbox = async (bookingID) => {
    const ret = await axios
        .post(`${baseURL}/comment/get`, { booking_id: bookingID });
    console.log(ret.data);
    return ret.data;
}
...
export const addComment_Chatbox = async (formData) => {
    const ret = 
    await axios.post(`${baseURL}/comment/add`, formData);
    return ret.data;
}
...
export const doctor_patient_list = async (requestBody) => {
    const ret = await axios
        .post(`${baseURL}/doctor/patientlist`, requestBody);
    return ret.data;
}
...
export const addTest = async (formData) => {
    const ret = await axios
    .post(`${baseURL}/hospital/addtest`, formData)
    return ret;
}
...
export const booking_to_assign_nurse = async (bookingID) => {
    const ret = await axios.get(`http://localhost:3000/hospital/onebooking/${bookingID}`);
    return ret.data;
}
...
export const available_doctor_hospital = async () => {
    const ret = await axios
        .get(`http://localhost:3000/hospital/doctor`)
    return ret.data;
}

export const available_driver_hospital = async () => {
    const ret = await axios
        .get(`http://localhost:3000/hospital/driver`)
    return ret.data;
}
...
export const pending_doctor_hospital = async () => {
    const ret = await axios
        .get(`http://localhost:3000/hospital/pending/doctor`)
    return ret.data;
}

export const pending_nurse_hospital = async () => {
    const ret = await axios
        .get(`http://localhost:3000/hospital/pending/nurse`)
    return ret.data;
}

export const pending_driver_hospital = async () => {
    const ret = await axios
        .get(`http://localhost:3000/hospital/pending/driver`)
    return ret.data;
}
...
export const reg_doctor = async (formData) => {
    const ret = await axios .post('http://localhost:3000/auth/register/doctor', formData)
    return ret.data;
}

export const reg_nurse = async (formData) => {
    const ret = await axios .post('http://localhost:3000/auth/register/nurse', formData)
    return ret.data;
}

export const reg_driver = async (formData) => {
    const ret = await axios .post('http://localhost:3000/auth/register/driver', formData)
    return ret.data;
}

export const reg_hospital = async (formData) => {
    const ret = await axios .post('http://localhost:3000/auth/register/hospital', formData)
    return ret.data;
}

export const reg_patient = async (formData) => {
    const ret = await axios .post('http://localhost:3000/auth/register/patient', formData)
    return ret.data;
}
...
export const editHospitalList_doctor = async (selectedHospital,doctor_id) => {
    const ret = await axios .get(`http://localhost:3000/doctor/timeline/${doctor_id}/?hospital=${selectedHospital}`);
    console.log(ret.data);
    return ret.data;
}

export const deleteTimeline_doctor = async (timeline_id) => {
    const ret = await axios .post(`http://localhost:3000/doctor/deleteSCHEDULE/${timeline_id}`);
    return ret.data;
}

export const updateSchedule_doctor = async (timeline_id, requestData) => {
    const ret = await axios .post(`http://localhost:3000/doctor/update-Schedule/${timeline_id}`, requestData);
    return ret.data;
}
